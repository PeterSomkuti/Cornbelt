\documentclass[preprint, a4paper, 10pt, times, 5p]{elsarticle}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../coverage_map.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../SIF_overview.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../anomalies_755_abs_0_median.pdf}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=\linewidth]{../anomalies_755_abs_2_median.pdf}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=\linewidth]{../SIF_flux_cumulative_CASA_NEE.pdf}
\caption{yadda yadda}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../corn_soy_planted_sif_18.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../corn_soy_yield_sif.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../corn_soy_yield_TOTAL_PLANTED.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../corn_soy_yield_VI_FRACTION.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../ndvi_crop/2012_VI_11_maximum.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../corn_soy_yield_LC_FRACTION.pdf}
...
%In the coming years, we expect to see more work on crop monitoring and yield prediction being published using SIF from these new space-based instruments.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../2012_curves_lowess2.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../anomalies_755_abs_1_median.pdf}
